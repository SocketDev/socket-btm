...
Custom Node.js v24.11.1 binary builder with Socket security patches.

## What it does

This package Downloads the Node.js v24.11.1 source code, applies Socket security patches, and then compiles a custom Node.js binary optimized for size and security.
...
2. **patch** - 131 Socket security patches applied
...
Socket applies **131 security and size-optimization patches** to Node.js v24.11.1:
- Security hardening
