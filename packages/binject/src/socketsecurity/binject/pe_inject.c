// ============================================================================
// pe_inject.c — PE (Windows) binary injection
// ============================================================================
//
// WHAT THIS FILE DOES
// Injects SEA and VFS data sections into Windows PE executables. Delegates
// to binject_pe_lief_batch() which uses the LIEF library to parse, modify,
// and write the binary in a single pass.
//
// WHY IT EXISTS
// PE is the executable format on Windows (.exe files). This file provides
// the platform-specific glue between the generic binject API and the
// LIEF-based PE manipulation code (written in C++).
// ============================================================================
