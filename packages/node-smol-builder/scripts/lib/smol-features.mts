...
export const SMOL_FEATURES: readonly SmolFeature[] = [
  feature({
    name: 'ai',
    description: 'On-device Prompt API (pinned llama.cpp + GGUF)',
    stringSignals: ['node:smol-ai', 'smol-ai'],
    memberSignals: [],
    configureFlagWhenDropped: '--without-smol-ai',
    optInFlag: undefined,
    gypVar: 'node_use_smol_ai',
    policy: 'auto',
    approxBinaryMb: 14,
  }),
  feature({
