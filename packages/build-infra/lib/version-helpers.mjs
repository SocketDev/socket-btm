...
export function getSubmoduleChecksum(submodulePath, packageName) {
  ...
  return { __proto__: null, algorithm: checksumMatch[1], hash: checksumMatch[2] }
}
 ...
 *
 * @param {string} version - Node.js version without 'v' prefix (e.g., '25.8.2')
 ...
 * @example
 * const result = await fetchNodeChecksum('25.8.2')
 * if ('hash' in result) {
 *   // Write to .gitmodules: # node-25.8.2 sha256:<result.hash>
 * }
 */
