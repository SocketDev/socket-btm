...
exports.findNodeAt = function (code, start, end, node_type, options_js) {
  try {
    ...
    wasm.findNodeAt(
      ...
      ptr0,
      len0,
      isLikeNone(start) ? 0x100000001 : start >>> 0,
      isLikeNone(end) ? 0x100000001 : end >>> 0,
      ptr1,
      len1,
      addHeapObject(options_js),
    )
...
if (Symbol.dispose)
  WasmParser.prototype[Symbol.dispose] = WasmParser.prototype.free

exports.WasmParser = WasmParser

exports.__wbg_call_641db1bb5db5a579 = function () {
...
exports.__wbg_get_458e874b43b18b25 = function () {
...
exports.__wbg_parse_442f5ba02e5eaf8b = function () {
  return handleError(function (arg0, arg1) {
...
exports.__wbg_set_453345bcda80b89a = function () {
  return handleError(function (arg0, arg1, arg2) {
