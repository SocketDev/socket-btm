// ============================================================================
// vfs_config.h — SVFG binary config format for VFS settings
// ============================================================================
//
// WHAT THIS FILE DOES
// Defines the struct and serialization API for the SVFG ("Smol VFS conFiG")
// binary format — a fixed-size 108-byte blob that stores VFS mode
// ("on-disk", "in-memory", "compat") and path prefix ("/snapshot").
//
// WHY IT EXISTS
// The runtime needs to know how to handle the embedded VFS archive (extract
// to disk or serve from memory) and what path prefix to use. This config
// is embedded as raw bytes alongside the VFS archive in the binary.
// ============================================================================
