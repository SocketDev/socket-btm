 ...
 *     scripts/repo/check-version-consistency.mts node
 *     scripts/repo/check-version-consistency.mts --explain node
 *     scripts/repo/check-version-consistency.mts --json Allowlist:
