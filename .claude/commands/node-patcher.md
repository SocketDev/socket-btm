...
Usage:
- `/node-patcher` - Regenerate all 13 patches
...
4. Regenerate all 13 patches from pristine Node.js v25.5.0 source
...
- 007: node-sea-smol-config-header.patch
- 008: node-sea-smol-config.patch
- 009: node-sea-header.patch
- 010: node-sea-bin-binject.patch
- 011: fix_v8_typeindex_macos.patch
- 012: vfs_bootstrap.patch
- 013: vfs_require_resolve.patch
...
- Patch list: `packages/node-smol-builder/patches/source-patched/` (001-013)
