...
// Mock dependencies
vi.mock<typeof import('@socketsecurity/lib-stable/bin/which')>(
...
describe('script-runner', () => {
  ...
  describe(runSequence, () => {
    it('should run commands in sequence', async () => {
      ...
      const commands = [
        { args: ['step1'], command: 'echo' },
        { args: ['step2'], command: 'echo' },
        { args: ['step3'], command: 'echo' },
      ]
    ...
    it('should use command descriptions if provided', async () => {
      ...
      const commands = [
        { args: ['hello'], command: 'echo', description: 'Say hello' },
      ]
  ...
  describe(runParallel, () => {
    it('should run multiple commands in parallel', async () => {
      ...
      const commands = [
        { args: ['task1'], command: 'echo' },
        { args: ['task2'], command: 'echo' },
        { args: ['task3'], command: 'echo' },
      ]
    ...
    it('should merge global options', async () => {
      ...
      const commands = [{ args: ['test'], command: 'echo' }]
