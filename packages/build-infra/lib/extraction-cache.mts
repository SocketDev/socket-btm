...
export function computeSourceHash(
  ...
  platformMetadata?: string | undefined,
  options?: { relativeTo?: string | undefined } | undefined,
): string {
  ...
  const pathForHash = (absolutePath: string) => {
 ...
 */
export function generateHashComment(sourcePaths: string | string[]): string {
...
export interface ShouldExtractOptions {
  ...
  validateOutput?: ((content: string) => boolean) | undefined
}
