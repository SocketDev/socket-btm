...
class CompressionCache {
  ...
  get(key, encoding) {
    // Reject unsupported encodings BEFORE touching stats/LRU so an
    // unknown Accept-Encoding value doesn't falsely inflate
    // cache_hits or reorder the LRU with no caller benefit.
    ...
    return encoding === 'br' ? entry.brotli : entry.gzip
  }
