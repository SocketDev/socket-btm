...
|---------|---------|---------|--------------|
| **build-infra** | Build system core (checkpoints, CMake, WASM) | 51 modules | @socketsecurity/lib, acorn, magic-string |
...
|---------|---------|--------|---------|
| **node-smol-builder** | Node.js v25 + Socket patches | Custom node binary | 9 source patches |
