// ============================================================================
// vfs_utils.h — VFS archive creation and source detection helpers
// ============================================================================
//
// WHAT THIS FILE DOES
// Declares helper functions for working with VFS (Virtual File System)
// sources: detecting whether a path is a .tar.gz, .tar, or directory,
// creating compressed archives from directories, and resolving paths.
//
// WHY IT EXISTS
// When building a single-executable app, you can bundle node_modules as a
// VFS archive inside the binary. The source might be a directory, a tar, or
// an already-compressed tar.gz. These utilities handle all three cases.
// ============================================================================
