...
export declare class Buffer {
  constructor(width: number, height: number, opts?: { widthMethod?: number; id?: string; respectAlpha?: boolean })
  ...
  drawText(text: string, x: number, y: number, fg?: ColorInput, bg?: ColorInput, attrs?: number): void
  drawChar(char: number, x: number, y: number, fg?: ColorInput, bg?: ColorInput, attrs?: number): void
  setCell(x: number, y: number, char: number, fg?: ColorInput, bg?: ColorInput, attrs?: number): void
  fillRect(x: number, y: number, width: number, height: number, bg?: ColorInput): void
  pushScissorRect(x: number, y: number, width: number, height: number): void
  popScissorRect(): void
  clearScissorRects(): void
  pushOpacity(opacity: number): void
  popOpacity(): void
  drawEditorView(editorView: EditorView | NativePointer, x: number, y: number): void
...
export declare class TextBuffer {
  ...
  resetDefaults(): void
  addHighlight(lineIdx: number, start: number, end: number, styleId: number, priority?: number, hlRef?: number): void
...
export declare class EditorView {
  constructor(editBuffer: EditBuffer | NativePointer, width: number, height: number)
  readonly ptr: NativePointer
  readonly cursor: CursorState | { row: number; col: number }
  readonly visualCursor: { visualRow: number; visualCol: number; logicalRow: number; logicalCol: number; offset: number }
  ...
  moveUpVisual(): void
  moveDownVisual(): void
  setSelection(start: number, end: number, bgColor?: ColorInput, fgColor?: ColorInput): void
  resetSelection(): void
...
export declare class SyntaxStyle {
  ...
  register(name: string, fg?: ColorInput, bg?: ColorInput, attrs?: number): number
  resolve(name: string): number
  destroy(): void
}

export declare class Renderer {
  constructor(width: number, height: number, opts?: { testing?: boolean; remote?: boolean })
  readonly ptr: NativePointer
