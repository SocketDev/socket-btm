 ...
 *   - algorithm (1 byte): 0=LZFSE, 1=LZMA, 2=LZMS
 *   - reserved (1 byte): Currently unused, set to 0
 ...
 * compressed_size (8) + uncompressed_size (8) + cache_key (16) + platform_metadata (5) = 37 bytes
 */
 ...
 * marker (32) + metadata (37) = 69 bytes
 */
