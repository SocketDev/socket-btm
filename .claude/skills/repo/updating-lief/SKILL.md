---
name: updating-lief
description: Align LIEF with Node and audit API compatibility.
user-invocable: true
...
- **Cache bumps**: `lief`, `binject`, `binpress`, `node-smol` (binflate does NOT link LIEF; matches CASCADE_RULES)
...
5. Bumps cache versions: lief, binject, binpress, node-smol
