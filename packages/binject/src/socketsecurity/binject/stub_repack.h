// ============================================================================
// stub_repack.h — API for repacking compressed self-extracting stubs
// ============================================================================
//
// WHAT THIS FILE DOES
// Declares the functions for the "repack" workflow: when you inject new data
// into a binary that was already compressed into a self-extracting stub,
// you must decompress it, inject, re-compress, and rebuild the stub. This
// header defines that multi-step pipeline.
//
// WHY IT EXISTS
// A compressed stub is a tiny executable (~50KB) with the real binary
// compressed inside it. If you need to inject new SEA/VFS data, you cannot
// just append to the stub — you must extract the inner binary, modify it,
// re-compress it, and put it back. This file declares the API for that.
// ============================================================================
 ...
 * @param quality Compression quality (reserved for future use)
 * @return 0 on success, -1 on error
 */
 ...
 * @param smol_config_binary Optional smol config binary (1192 bytes, SMFG v2) or NULL
 * @param extracted_path Path to extracted binary with NODE_SEA sections (for preservation)
 * @return 0 on success, -1 on error
 */
