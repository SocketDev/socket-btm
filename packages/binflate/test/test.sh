...
if [ "$PLATFORM" = "Darwin" ] || [ "$PLATFORM" = "Linux" ]; then
    COMPRESSOR="$BINPRESS_DIR/build/$BUILD_MODE/out/binpress"
    DECOMPRESSOR="$PACKAGE_DIR/build/$BUILD_MODE/out/binflate"
else
    COMPRESSOR="$BINPRESS_DIR/build/$BUILD_MODE/out/binpress.exe"
    DECOMPRESSOR="$PACKAGE_DIR/build/$BUILD_MODE/out/binflate.exe"
fi
