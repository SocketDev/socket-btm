...
// Documentation: docs/additions/lib/internal/socketsecurity/vfs/pg_provider.js.md
...
class SmolPgProvider {
  ...
  async rename(oldPath, newPath) {
    ...
    // destroy both source and destination via the getByPrefix(op)
    // loop below. Matches rename(2) semantics.
