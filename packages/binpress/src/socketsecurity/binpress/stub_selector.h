// ============================================================================
// stub_selector.h — Decompressor stub selection and management
// ============================================================================
//
// WHAT THIS FILE DOES
// Declares the API for selecting the right decompressor stub for a given
// target platform/architecture. Stubs are tiny self-extracting executables
// (~50KB) that are compiled into binpress as C byte arrays at build time.
// This header lets callers pick the right stub, write it to a temp file,
// and clean it up afterward.
//
// WHY IT EXISTS
// binpress needs to produce self-extracting binaries for 8 different
// platform/arch combinations (darwin-arm64, linux-x64-musl, win-x64, etc.).
// Each target needs its own decompressor stub. Rather than shipping stub
// files alongside binpress, they are embedded in the binary itself.
// ============================================================================
