 ...
 *
 * A high-performance, Bun-compatible SQL interface for PostgreSQL and SQLite
 * with tagged template literals. Write secure SQL queries that are automatically
 * parameterized.
 */
