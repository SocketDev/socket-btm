...
| ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------- |
| `× @socketsecurity/lib-stable not resolvable from /home/runner/work/...`               | Root `package.json` is missing the runtime dep the setup action requires.      | Add `"@socketsecurity/lib-stable": "catalog:"` next to `lib-stable` in the root `package.json` + catalog entry. |
