 ...
 * Uses AST-based transformations (acorn + MagicString) for robust code
 * modification.
 */
 ...
 * @param {boolean} options.convertDefaultExport - Convert default export to
 *   variable.
 * @param {string} options.defaultExportName - Name for converted default export
 *   variable.
 * @param {boolean} options.removeDefaultExport - Remove default export
 *   entirely.
 * @param {boolean} options.convertExportConst - Convert 'export const' to
 *   'const'
 *
