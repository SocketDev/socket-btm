 ...
 *
 * Derives Python path from `pip --version` output which shows the pip
 * installation path. From this path, we can find the corresponding Python.
 *
 * @returns {string|undefined} Resolved python command path or undefined if not found.
 */
export function getPythonCommand() {
  ...
  try {
    ...
    const pathMatch = pipVersion.match(/from\s+(.+?)(?:\s+\(|$)/)
    if (pathMatch) {
