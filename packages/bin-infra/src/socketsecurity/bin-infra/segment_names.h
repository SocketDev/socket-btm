...
#define SMOL_VFS_CONFIG_RESOURCE_NAME "SMOL_VFS_CONFIG"
#define PRESSED_DATA_RESOURCE_NAME "PRESSED_DATA"
// SMOL Node Version - shortened to fit Mach-O 16-char section name limit (15 with __ prefix)
#define SMOL_NODE_VER_RESOURCE_NAME "SMOL_NODE_VER"
...
#define MACHO_SECTION_PRESSED_DATA "__" PRESSED_DATA_RESOURCE_NAME
#define MACHO_SECTION_NODE_SEA_BLOB "__" NODE_SEA_RESOURCE_NAME
#define MACHO_SECTION_SMOL_VFS_BLOB "__" SMOL_VFS_RESOURCE_NAME
#define MACHO_SECTION_SMOL_VFS_CONFIG "__" SMOL_VFS_CONFIG_RESOURCE_NAME
#define MACHO_SECTION_SMOL_NODE_VER "__" SMOL_NODE_VER_RESOURCE_NAME

// ELF section names (dot prefix - for binpress)
...
#define ELF_NOTE_SMOL_VFS_CONFIG SMOL_VFS_CONFIG_RESOURCE_NAME
#define ELF_NOTE_PRESSED_DATA PRESSED_DATA_RESOURCE_NAME
#define ELF_NOTE_SMOL_NODE_VER SMOL_NODE_VER_RESOURCE_NAME

// PE section names (dot prefix - for binpress)
...
#define PE_RESOURCE_SMOL_VFS_CONFIG SMOL_VFS_CONFIG_RESOURCE_NAME
#define PE_RESOURCE_SMOL_NODE_VER SMOL_NODE_VER_RESOURCE_NAME
