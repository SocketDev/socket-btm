...
echo "==================================================================="
node scripts/check-consistency.mts | grep -A 5 "test-pkg-temp" || echo "No test-pkg-temp issues shown (expected if checks don't cover this)"
...
echo "==================================================================="
node scripts/check-consistency.mts --dry-run | tail -20
...
echo "==================================================================="
node scripts/check-consistency.mts --fix | tail -20
...
echo "==================================================================="
node scripts/check-consistency.mts --suggest | grep -A 30 "ML-Powered Suggestions" || echo "No suggestions found"
