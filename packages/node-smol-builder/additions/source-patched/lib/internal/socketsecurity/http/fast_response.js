...
function nativeWriteNotModified(...args) { return smolHttp().writeNotModifiedResponse(...args); }

// Lazy: json_cache does work at module scope that we don't want during bootstrap.
let _jsonCache;
function getJsonCache() { return _jsonCache || (_jsonCache = require('internal/socketsecurity/http/json_cache')); }
function createCacheKey(...args) { return getJsonCache().createCacheKey(...args); }
function stringifyWithCache(...args) { return getJsonCache().stringifyWithCache(...args); }
