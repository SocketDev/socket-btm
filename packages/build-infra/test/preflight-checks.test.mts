...
vi.mock<typeof BuildOutput>(import('../lib/build-output.mts'), () => ({
  printError: vi.fn(),
}))
...
describe('preflight-checks', () => {
  let mockCheckDiskSpace: Mock
  let mockCheckCompiler: Mock
  let mockCheckPythonVersion: Mock
