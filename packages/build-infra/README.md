...
- `lief-downloader` - LIEF binary parser library
...
### Testing
- `test/helpers` - Test utilities for binary validation (imported as `./lib/test-helpers`)
- Includes segment name constants and file size validation
