...
- `@node-versions`: Node.js version this patch was generated against (e.g., `v24.x`)
  - Must always be a specific version, never wildcards like `v24+`
...
```bash
node scripts/update-node-version.mjs 24.13.0
```
