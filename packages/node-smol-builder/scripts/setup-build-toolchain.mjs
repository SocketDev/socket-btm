 ...
 * - Linux: gcc, make, liblzma-dev, libssl-dev (for stub binary)
 * - Linux (musl builds): musl-tools, gcc-aarch64-linux-gnu (cross-compilation)
 * - macOS: clang (Xcode), make, openssl@3
 * - Windows: mingw-w64 (gcc), make (bundled OpenSSL)
 */
