...
# curl is OPTIONAL - if not found, stubs build without HTTPS update checking.
ifneq ($(MAKECMDGOALS),clean)
    ifneq (,$(wildcard $(CURL_BUILD_DIR)/libcurl.a))
        ...
        # curl not found - build without HTTPS update checking support.
        # This is intentionally not an error - curl is optional.
        CURL_DIR =
        $(info NOTE: curl libraries not found at $(CURL_BUILD_DIR) or $(CURL_DOWNLOADED_DIR). Building without HTTPS update checking support.)
    endif
else
