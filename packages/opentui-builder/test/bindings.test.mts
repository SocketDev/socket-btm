// max-file-lines: test-suite -- exhaustive low-level FFI binding coverage for every native call exposed by lib/index.mts; one file per binding module matches the fleet's test-layout convention and splitting would scatter related smoke assertions across files
...
describe('optimized buffer', () => {
  ...
  it('creates with dimensions and id', () => {
    buffer = native.createOptimizedBuffer(
      40,
      10,
      false,
      WidthMethod.WCWIDTH,
  ...
  it('composites frame buffer onto target', () => {
    expect(() => {
      ...
      const source = native.createOptimizedBuffer(
        10,
        5,
        false,
        WidthMethod.WCWIDTH,
...
describe('text buffer', () => {
  ...
  it('manages default attributes', () => {
    expect(() => {
      native.textBufferSetDefaultAttributes(
        tb,
  ...
  it('manages highlights', () => {
    ...
    const styleId = native.syntaxStyleRegister(
      style,
      'keyword',
      0,
      0.5,
...
describe('text buffer view', () => {
  ...
  it('manages selection', () => {
    native.textBufferViewSetSelection(
      view,
      0,
      5,
      0.2,
...
describe('editor view', () => {
  ...
  it('draws into buffer', () => {
    expect(() => {
      const buffer = native.createOptimizedBuffer(
        40,
        10,
        false,
        WidthMethod.WCWIDTH,
...
describe('syntax style', () => {
  ...
  it('registers styles with incremental IDs', () => {
    const id1 = native.syntaxStyleRegister(
      style,
      'keyword',
      0,
      0,
    ...
    const id2 = native.syntaxStyleRegister(
      style,
      'string',
      0,
      1,
...
const hasDirectBufferAPIs =
  typeof native.bufferGetCharArrayBuffer === 'function'
