...
- **bin-stub-builder**: Builds self-extracting stub binaries
...
- **tui-infra**: Source-only C++ TUI primitives embedded into node-smol-builder as the `node:smol-tui` builtin — kitty/fixterms/SGR keyboard + mouse decoding
