...
| `createStreamingParser(format)`   | Create a streaming parser for large files |
...
| `parseLockfile(content, format)`  | Parse a lockfile by format                |
| `parseManifest(content, format)`  | Parse a manifest by format                |
