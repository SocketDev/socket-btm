...
- Native bindings and UI libraries (OpenTUI, `node:smol-tui`) compiled from C/C++/Go/Zig sources.
...
|                    | [bin-stub-builder](packages/bin-stub-builder/)           | Self-extracting stub binaries for compressed executables     |
...
|                    | [tui-infra](packages/tui-infra/)                         | Source-only C++ TUI primitives embedded as `node:smol-tui`   |
