 ...
 *
 * Usage: node scripts/check-consistency.mts # Check only node
 * scripts/check-consistency.mts --fix # Auto-fix all fixable issues node
 * scripts/check-consistency.mts --interactive # Ask before fixing each issue
 * node scripts/check-consistency.mts --dry-run # Show what would be fixed node
 * scripts/check-consistency.mts --suggest # Show ML-powered suggestions.
 *
