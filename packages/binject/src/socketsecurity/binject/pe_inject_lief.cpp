// ============================================================================
// pe_inject_lief.cpp — Inject data into PE binaries (Windows executables)
// ============================================================================
//
// WHAT THIS FILE DOES
// Injects named resources into PE (Windows) binaries using LIEF. Uses the
// RT_RCDATA resource type in the .rsrc section — the same approach as
// Node.js's postject tool, ensuring SEA compatibility on Windows.
//
// WHY IT EXISTS
// Windows PE executables store embedded resources differently from ELF
// (notes) and Mach-O (segments). PE uses a resource tree with typed
// entries. LIEF handles the complex resource tree manipulation.
// ============================================================================
/**
...
static int inject_pe_resource(LIEF::PE::Binary* binary,
    ...
    std::u16string u16_name = binject::to_u16string(upper_name);
