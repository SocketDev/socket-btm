...
const smolHandlers = {
  ...
  lstatSync(path, options) {
    // Same as statSync for VFS/SEA - no symlinks supported
    return smolHandlers.statSync(path, options)
  },
  ...
  // === Missing Intercepts (glob*, realpathSync.native) ===
  ...
  // glob/globSync are not intercepted yet as they're complex iterators
  // When Node.js adds VFS glob support, we can follow their pattern
}
