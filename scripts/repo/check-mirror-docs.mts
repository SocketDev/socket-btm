 ...
 *      run check` via check.mts. Usage: node scripts/repo/check-mirror-docs.mts
 *      node scripts/repo/check-mirror-docs.mts --explain node
 *      scripts/repo/check-mirror-docs.mts --json Allowlist:
