...
- `packages/bin-stubs/src/socketsecurity/bin-stubs/update_config.h` - Contains `update_config_from_binary()` function

**Stub integration**:
- `packages/bin-stubs/src/socketsecurity/bin-stubs/elf_stub.c` - Linux ELF stub (reads SMFG config)
- `packages/bin-stubs/src/socketsecurity/bin-stubs/macho_stub.c` - macOS Mach-O stub
- `packages/bin-stubs/src/socketsecurity/bin-stubs/pe_stub.c` - Windows PE stub
