...
import { BUILD_DIR, DIST_DIR, PACKAGE_ROOT, PATCHES_DIR } from './paths.mjs'
...
async function main() {
  ...
  const tarResult = await spawn('tar', ['-xzf', tarballPath, '-C', extractDir], {
    cwd: BUILD_DIR,
    stdio: 'pipe',
  })
