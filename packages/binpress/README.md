...
binpress input.bin -o output.bin
```
...
Note: At least one output (-o or -d) must be specified.
      Compressed stubs are automatically detected and repacked when recompressed.
```
...
**Workflow:** `.github/workflows/binsuite.yml` (binpress job)
