...
vi.mock<typeof import('../lib/build-helpers.mts')>(
  import('../lib/build-helpers.mts'),
  () => ({
    checkCompiler: vi.fn(),
...
vi.mock<typeof import('../lib/build-output.mts')>(
  import('../lib/build-output.mts'),
  () => ({
    printError: vi.fn(),
  }),
)

vi.mock<typeof import('../lib/version-helpers.mts')>(
  import('../lib/version-helpers.mts'),
  () => ({
