...
# Only decompression + common sources are compiled (compression uses full lib).
...
ZSTD_CFLAGS_BUILD = -O2 -Wall -DNDEBUG -DZSTD_MULTITHREAD=0 -DZSTD_DISABLE_ASM -fvisibility=hidden $(ARCH_FLAGS)
