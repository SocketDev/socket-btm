 ...
 *
 * Converts the C++ SmolUpdateConfig struct to a 1192-byte SMFG v2 format binary
 ...
 * @return Serialized binary blob (108 bytes), or nullopt on error
 */
 ...
 * @param vfs_config_blob Optional serialized VFS config (SVFG format, 108 bytes)
