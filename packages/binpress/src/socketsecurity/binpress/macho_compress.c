// ============================================================================
// macho_compress.c — Mach-O (macOS) platform routing for binpress
// ============================================================================
//
// WHAT THIS FILE DOES
// Provides the platform-specific binpress_platform_route() for the macOS
// build. Routes compression to the appropriate function based on the target
// stub's format (native Mach-O, or cross-platform ELF/PE via LIEF).
//
// WHY IT EXISTS
// The macOS build of binpress compiles this file to provide the Mach-O
// main(). It includes binpress_main.c (shared entry point) and only adds
// the short routing function.
// ============================================================================

/**
 * macOS Mach-O Binary Compressor
 *
 * Compresses Mach-O binaries using ZSTD compression.
