...
# Downloaded LIEF uses nested lief/assets/ subdirectory
LIEF_DOWNLOADED_DIR = $(LIEF_BUILDER_ROOT)/build/downloaded/lief/$(PLATFORM_ARCH)/lief/assets
LIEF_BUILD_DIR = $(LIEF_BUILDER_ROOT)/build/$(BUILD_MODE)/out/Final/lief
