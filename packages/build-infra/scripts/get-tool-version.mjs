...
function parseArgs(args) {
  ...
  if (!toolName || !versionKey) {
    ...
    console.error('  get-tool-version.mjs python recommendedVersion')
    console.error(
...
function main() {
  ...
  if (!version) {
    console.error(
      `Error: No version found for tool '${toolName}' with version key '${versionKey}'`,
    )
