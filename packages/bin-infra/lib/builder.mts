...
export interface BuildBinSuitePackageConfig {
  ...
  beforeBuild?:
    ...
    | undefined
  smokeTest?: ((binaryPath: string) => Promise<void>) | undefined
  skipClean?: boolean | undefined
  validateCheckpointWithBinary?: boolean | undefined
}
 ...
 */
export async function buildBinSuitePackage(config: BuildBinSuitePackageConfig) {
  const {
    beforeBuild,
    packageDir,
    packageName,
 ...
 * @returns {Promise<void>}
 */
export async function defaultSmokeTest(
  binaryPath: string,
  packageName: string,
) {
