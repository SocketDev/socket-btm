 ...
 * The compressed binary format is the same as native Linux compression.
 *
...
int elf_compress_lief(const char* input_path,
  ...
  try {
    printf("Using LIEF for ELF compression (cross-platform)...\n");
    printf("  Input: %s\n", input_path);
    printf("  Output: %s\n", output_path);
    printf("  Algorithm: %s\n",
    ...
    std::unique_ptr<LIEF::ELF::Binary> binary =
        LIEF::ELF::Parser::parse(input_path);
    ...
    printf("Parsed ELF binary successfully\n");
