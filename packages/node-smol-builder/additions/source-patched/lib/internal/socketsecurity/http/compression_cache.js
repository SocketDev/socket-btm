...
function getBrotliCompress() {
  if (!_brotliCompress) _brotliCompress = promisify(ZlibBrotliCompress);
  return _brotliCompress;
}

let _gzipCompress;
function getGzipCompress() {
  if (!_gzipCompress) _gzipCompress = promisify(ZlibGzip);
...
module.exports = {
  __proto__: null,
  CompressionCache,
  get compressionCache() { return getCompressionCache(); },
};
