// ============================================================================
// smol_extract_lief.cpp — Extract compressed binary from a SMOL stub
// ============================================================================
//
// WHAT THIS FILE DOES
// Uses LIEF to read the __PRESSED_DATA section from a compressed SMOL stub,
// finds the magic marker, reads the size headers, decompresses the data,
// and writes the original binary to an output file.
//
// WHY IT EXISTS
// binject needs to extract the inner binary from a compressed stub before
// it can inject new SEA/VFS resources (the "repack" workflow). This file
// provides that extraction capability across all platforms via LIEF.
// ============================================================================
