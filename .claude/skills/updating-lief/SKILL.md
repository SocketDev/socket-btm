...
- **To update LIEF**: First update Node.js (use updating-node skill), then sync LIEF submodule to match
...
- Node.js updated to a version with newer LIEF in deps/
- Access new LIEF features available in Node.js
