// ============================================================================
// elf_inject_lief.cpp — Inject data into ELF binaries (Linux executables)
// ============================================================================
//
// WHAT THIS FILE DOES
// Injects named data segments (SEA blob, VFS archive, configs) into ELF
// binaries using raw PT_NOTE manipulation. Preserves the Program Header Table
// (PHT) location — critical because static glibc binaries crash (SIGSEGV) if
// the PHT is moved.
//
// WHY IT EXISTS
// LIEF (the binary format library) can inject into ELF but moves the PHT,
// breaking static glibc binaries. This file bypasses LIEF for writes and
// does raw binary manipulation instead. LIEF is still used for read-only
// operations (list, extract, verify).
// ============================================================================
