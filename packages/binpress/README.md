...
Compresses a Node.js binary with zstd and wraps it in a small self-extracting stub (from bin-stub-builder). The result is a single executable that decompresses itself on launch via binflate.
