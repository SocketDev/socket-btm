...
export const unicodePropertyMap = {
  ...
  Mark:
    ...
    '\\u0300-\\u036F\\u0483-\\u0489\\u0591-\\u05BD\\u05BF\\u05C1-\\u05C2\\u05C4-\\u05C5\\u05C7\\u0610-\\u061A\\u064B-\\u065F\\u0670\\u06D6-\\u06DC\\u06DF-\\u06E4\\u06E7-\\u06E8\\u06EA-\\u06ED',
...
export function transformUnicodePropertyEscapes(content) {
  ...
  walkSimple(ast, {
    Literal(node) {
      // Acorn uses Literal for regex, check if it has regex property
      if (!node.regex) {
        return
      }
    ...
    NewExpression(node) {
      ...
      // Both arguments must be string literals (Acorn uses 'Literal' type).
      if (patternArg.type !== 'Literal' || flagsArg.type !== 'Literal') {
        return
      }
