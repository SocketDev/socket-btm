...
- [ultraviolet-builder](packages/ultraviolet-builder/) - Charmbracelet Ultraviolet terminal decoder (kitty/fixterms/SGR) compiled from Go via napi-go

### N-API Frameworks

- [napi-go](packages/napi-go/) - Go → N-API framework (the napi-rs analog for Go), source-distributed from this repo
