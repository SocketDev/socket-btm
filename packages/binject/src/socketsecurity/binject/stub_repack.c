 ...
 */
int binject_repack_stub(const char *stub_path, const char *compressed_data_path, const char *output_path, size_t uncompressed_size, const uint8_t *smol_config_binary) {
...
int binject_repack_workflow(const char *stub_path, const char *extracted_path, const char *output_path, const uint8_t *smol_config_binary) {
    ...
    if (binject_repack_stub(stub_path, temp_compressed, output_path, uncompressed_size, smol_config_binary) != 0) {
