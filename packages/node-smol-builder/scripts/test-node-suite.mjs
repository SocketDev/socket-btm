 ...
 * - corepack tests (disabled with --without-corepack)
...
async function main() {
  ...
  // Verify Node.js source submodule.
  const nodeSourcePath = SUBMODULE_PATH
  if (!existsSync(nodeSourcePath)) {
    logger.fail('Node.js source submodule not found')
    logger.log('')
