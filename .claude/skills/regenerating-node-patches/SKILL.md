...
<action>
Read original patch to understand Socket Security changes, then apply modifications:
</action>
...
# Read original patch to understand what changes to apply
# Look at the diff hunks (lines starting with + and -)
...
# Recreate the changes shown in the original patch
\`\`\`

<validation>
Think through these validation questions:
1. Did you read the original patch header (Socket Security comments)?
2. Did you understand what changes are being made?
3. Did you apply ALL changes from the original patch?
4. Did you verify the modifications are correct?
...
- Standard diff headers: --- a/FILE and +++ b/FILE
