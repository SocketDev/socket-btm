...
interface OpenTUIBindings {
  ...
  setEventCallback(callback: (eventType: number, data: ArrayBuffer) => void): void

  // ── Renderer ──

  createRenderer(width: number, height: number, testing: boolean, remote: boolean): NativePointer
  ...
  setBackgroundColor(renderer: NativePointer, r: number, g: number, b: number, a: number): void
  setRenderOffset(renderer: NativePointer, offset: number): void
  setUseThread(renderer: NativePointer, useThread: boolean): void
  setDebugOverlay(renderer: NativePointer, enabled: boolean, corner: number): void
  clearTerminal(renderer: NativePointer): void
  setCursorPosition(renderer: NativePointer, x: number, y: number, visible: boolean): void
  setTerminalEnvVar(renderer: NativePointer, key: string, value: string): boolean
  updateStats(renderer: NativePointer, time: number, fps: number, frameCallbackTime: number): void
  updateMemoryStats(renderer: NativePointer, heapUsed: number, heapTotal: number, arrayBuffers: number): void
  ...
  setCursorColor(renderer: NativePointer, r: number, g: number, b: number, a: number): void
  setCursorStyleOptions(renderer: NativePointer, style: number, blinking: boolean, cursor: number, r: number, g: number, b: number, a: number): void
  getCursorState(renderer: NativePointer): { x: number; y: number; visible: boolean }
  setTerminalTitle(renderer: NativePointer, title: string): void
  copyToClipboardOSC52(renderer: NativePointer, target: number, payload: string): boolean
  ...
  createOptimizedBuffer(width: number, height: number, respectAlpha: boolean, widthMethod: number, id: string): NativePointer
  destroyOptimizedBuffer(buffer: NativePointer): void
  destroyFrameBuffer(frameBuffer: NativePointer): void
  drawFrameBuffer(target: NativePointer, destX: number, destY: number, frameBuffer: NativePointer, sourceX: number, sourceY: number, sourceWidth: number, sourceHeight: number): void
  getBufferWidth(buffer: NativePointer): number
  getBufferHeight(buffer: NativePointer): number
  bufferClear(buffer: NativePointer, r: number, g: number, b: number, a: number): void
  bufferResize(buffer: NativePointer, width: number, height: number): void
  bufferFillRect(buffer: NativePointer, x: number, y: number, width: number, height: number, r: number, g: number, b: number, a: number): void
  ...
  bufferWriteResolvedChars(buffer: NativePointer, addLineBreaks: boolean): number
  bufferDrawText(buffer: NativePointer, text: string, x: number, y: number, fgR: number, fgG: number, fgB: number, fgA: number, bgR: number, bgG: number, bgB: number, bgA: number, attributes: number): void
  bufferSetCellWithAlphaBlending(buffer: NativePointer, x: number, y: number, char: number, fgR: number, fgG: number, fgB: number, fgA: number, bgR: number, bgG: number, bgB: number, bgA: number, attributes: number): void
  bufferSetCell(buffer: NativePointer, x: number, y: number, char: number, fgR: number, fgG: number, fgB: number, fgA: number, bgR: number, bgG: number, bgB: number, bgA: number, attributes: number): void
  bufferColorMatrix(buffer: NativePointer, matrix: Float32Array, cellMask: Float32Array, cellMaskCount: number, strength: number, target: number): void
  bufferColorMatrixUniform(buffer: NativePointer, matrix: Float32Array, strength: number, target: number): void
  bufferDrawPackedBuffer(buffer: NativePointer, data: ArrayBuffer, posX: number, posY: number, terminalWidthCells: number, terminalHeightCells: number): void
  bufferDrawGrayscaleBuffer(buffer: NativePointer, posX: number, posY: number, intensities: Float32Array, srcWidth: number, srcHeight: number, fgR: number, fgG: number, fgB: number, fgA: number, bgR: number, bgG: number, bgB: number, bgA: number): void
  bufferDrawGrayscaleBufferSupersampled(buffer: NativePointer, posX: number, posY: number, intensities: Float32Array, srcWidth: number, srcHeight: number, fgR: number, fgG: number, fgB: number, fgA: number, bgR: number, bgG: number, bgB: number, bgA: number): void
  bufferPushScissorRect(buffer: NativePointer, x: number, y: number, width: number, height: number): void
  ...
  bufferDrawSuperSampleBuffer(buffer: NativePointer, x: number, y: number, pixelData: ArrayBuffer, format: number, alignedBytesPerRow: number): void
  bufferDrawGrid(buffer: NativePointer, borderChars: ArrayBuffer, borderFgR: number, borderFgG: number, borderFgB: number, borderFgA: number, borderBgR: number, borderBgG: number, borderBgB: number, borderBgA: number, colOffsets: ArrayBuffer, rowOffsets: ArrayBuffer, options: ArrayBuffer): void
  bufferDrawBox(buffer: NativePointer, x: number, y: number, w: number, h: number, borderChars: ArrayBuffer, packedOpts: number, borderR: number, borderG: number, borderB: number, borderA: number, bgR: number, bgG: number, bgB: number, bgA: number): void
  bufferDrawEditorView(buffer: NativePointer, editorView: NativePointer, x: number, y: number): void
  bufferDrawTextBufferView(buffer: NativePointer, textBufferView: NativePointer, x: number, y: number): void
  bufferDrawChar(buffer: NativePointer, char: number, x: number, y: number, fgR: number, fgG: number, fgB: number, fgA: number, bgR: number, bgG: number, bgB: number, bgA: number, attributes: number): void
  ...
  addToHitGrid(renderer: NativePointer, x: number, y: number, width: number, height: number, id: number): void
  clearCurrentHitGrid(renderer: NativePointer): void
  hitGridPushScissorRect(renderer: NativePointer, x: number, y: number, width: number, height: number): void
  hitGridPopScissorRect(renderer: NativePointer): void
  hitGridClearScissorRects(renderer: NativePointer): void
  addToCurrentHitGridClipped(renderer: NativePointer, x: number, y: number, width: number, height: number, id: number): void
  ...
  textBufferSetDefaultFg(textBuffer: NativePointer, r: number, g: number, b: number, a: number): void
  textBufferSetDefaultBg(textBuffer: NativePointer, r: number, g: number, b: number, a: number): void
  textBufferSetDefaultAttributes(textBuffer: NativePointer, attributes: number): void
  ...
  textBufferRegisterMemBuffer(textBuffer: NativePointer, data: string, owned: boolean): string
  textBufferReplaceMemBuffer(textBuffer: NativePointer, id: string, data: string, owned: boolean): void
  ...
  textBufferSetStyledText(textBuffer: NativePointer, chunks: ArrayBuffer, chunkCount: number): void
  textBufferGetLineCount(textBuffer: NativePointer): number
  textBufferGetPlainText(textBuffer: NativePointer): string
  textBufferAddHighlight(textBuffer: NativePointer, lineIdx: number, start: number, end: number, styleId: number, priority: number, hlRef: number): void
  textBufferAddHighlightByCharRange(textBuffer: NativePointer, start: number, end: number, styleId: number, priority: number, hlRef: number): void
  textBufferRemoveHighlightsByRef(textBuffer: NativePointer, hlRef: number): void
  textBufferClearLineHighlights(textBuffer: NativePointer, lineIdx: number): void
  textBufferClearAllHighlights(textBuffer: NativePointer): void
  textBufferSetSyntaxStyle(textBuffer: NativePointer, syntaxStyle: NativePointer): void
  textBufferGetLineHighlightsPtr(textBuffer: NativePointer, lineIdx: number): ArrayBuffer
  ...
  textBufferGetTextRange(textBuffer: NativePointer, startOffset: number, endOffset: number): string
  textBufferGetTextRangeByCoords(textBuffer: NativePointer, startRow: number, startCol: number, endRow: number, endCol: number): string

  // ── TextBufferView ──

  createTextBufferView(textBuffer: NativePointer): NativePointer
  destroyTextBufferView(view: NativePointer): void
  textBufferViewSetSelection(view: NativePointer, start: number, end: number, bgR: number, bgG: number, bgB: number, bgA: number, fgR: number, fgG: number, fgB: number, fgA: number): void
  textBufferViewResetSelection(view: NativePointer): void
  textBufferViewGetSelectionInfo(view: NativePointer): { start: number; end: number } | undefined
  textBufferViewSetLocalSelection(view: NativePointer, anchorX: number, anchorY: number, focusX: number, focusY: number, bgR: number, bgG: number, bgB: number, bgA: number, fgR: number, fgG: number, fgB: number, fgA: number): boolean
  textBufferViewUpdateSelection(view: NativePointer, end: number, bgR: number, bgG: number, bgB: number, bgA: number, fgR: number, fgG: number, fgB: number, fgA: number): void
  textBufferViewUpdateLocalSelection(view: NativePointer, anchorX: number, anchorY: number, focusX: number, focusY: number, bgR: number, bgG: number, bgB: number, bgA: number, fgR: number, fgG: number, fgB: number, fgA: number): boolean
  ...
  textBufferViewSetViewportSize(view: NativePointer, width: number, height: number): void
  textBufferViewSetViewport(view: NativePointer, x: number, y: number, width: number, height: number): void
  ...
  textBufferViewSetTabIndicatorColor(view: NativePointer, r: number, g: number, b: number, a: number): void
  textBufferViewSetTruncate(view: NativePointer, truncate: boolean): void
  textBufferViewMeasureForDimensions(view: NativePointer, width: number, height: number): { lines: number; width: number }
  ...
  editBufferDeleteRange(editBuffer: NativePointer, startRow: number, startCol: number, endRow: number, endCol: number): void
  ...
  editBufferSetCursorToLineCol(editBuffer: NativePointer, row: number, col: number): void
  ...
  editBufferOffsetToPosition(editBuffer: NativePointer, offset: number): { row: number; col: number }
  editBufferPositionToOffset(editBuffer: NativePointer, row: number, col: number): number
  editBufferGetLineStartOffset(editBuffer: NativePointer, row: number): number
  editBufferGetTextRange(editBuffer: NativePointer, startOffset: number, endOffset: number): string
  editBufferGetTextRangeByCoords(editBuffer: NativePointer, startRow: number, startCol: number, endRow: number, endCol: number): string
  ...
  editBufferGetCursorPosition(editBuffer: NativePointer): { row: number; col: number; offset: number }
  ...
  createEditorView(editBuffer: NativePointer, viewportWidth: number, viewportHeight: number): NativePointer
  destroyEditorView(view: NativePointer): void
  editorViewSetViewport(view: NativePointer, x: number, y: number, width: number, height: number, moveCursor: boolean): void
  editorViewClearViewport(view: NativePointer): void
  editorViewGetViewport(view: NativePointer): { x: number; y: number; width: number; height: number }
  ...
  editorViewSetViewportSize(view: NativePointer, width: number, height: number): void
  editorViewSetWrapMode(view: NativePointer, mode: number): void
  editorViewSetSelection(view: NativePointer, start: number, end: number, bgR: number, bgG: number, bgB: number, bgA: number, fgR: number, fgG: number, fgB: number, fgA: number): void
  editorViewResetSelection(view: NativePointer): void
  editorViewGetSelection(view: NativePointer): { start: number; end: number } | undefined
  editorViewSetLocalSelection(view: NativePointer, anchorX: number, anchorY: number, focusX: number, focusY: number, bgR: number, bgG: number, bgB: number, bgA: number, fgR: number, fgG: number, fgB: number, fgA: number, updateCursor: boolean, followCursor: boolean): boolean
  editorViewUpdateSelection(view: NativePointer, end: number, bgR: number, bgG: number, bgB: number, bgA: number, fgR: number, fgG: number, fgB: number, fgA: number): void
  editorViewUpdateLocalSelection(view: NativePointer, anchorX: number, anchorY: number, focusX: number, focusY: number, bgR: number, bgG: number, bgB: number, bgA: number, fgR: number, fgG: number, fgB: number, fgA: number, updateCursor: boolean, followCursor: boolean): boolean
  ...
  editorViewGetVisualCursor(view: NativePointer): { visualRow: number; visualCol: number; logicalRow: number; logicalCol: number; offset: number }
  ...
  editorViewSetPlaceholderStyledText(view: NativePointer, chunks: ArrayBuffer, chunkCount: number): void
  editorViewSetTabIndicator(view: NativePointer, indicator: number): void
  editorViewSetTabIndicatorColor(view: NativePointer, r: number, g: number, b: number, a: number): void

  // ── SyntaxStyle ──

  createSyntaxStyle(): NativePointer
  destroySyntaxStyle(style: NativePointer): void
  syntaxStyleRegister(style: NativePointer, name: string, fgR: number, fgG: number, fgB: number, fgA: number, bgR: number, bgG: number, bgB: number, bgA: number, attributes: number): number
  ...
  streamReserve(stream: NativePointer, minLen: number): { ptr: ArrayBuffer; len: number } | number
  ...
  bufferDrawTextFA(buffer: NativePointer, text: string, x: number, y: number, fg: Float32Array, bg: Float32Array, attributes: number): void
  bufferSetCellFA(buffer: NativePointer, x: number, y: number, char: number, fg: Float32Array, bg: Float32Array): void
  bufferDrawCharFA(buffer: NativePointer, char: number, x: number, y: number, fg: Float32Array, bg: Float32Array, attributes: number): void
  bufferFillRectFA(buffer: NativePointer, x: number, y: number, width: number, height: number, bg: Float32Array): void

  // ── Performance: binary render paths ──

  bufferDrawPackedBufferBinary(buffer: NativePointer, data: Uint8Array, posX: number, posY: number, terminalWidthCells: number, terminalHeightCells: number): void
