// ============================================================================
// stub_elf_compress_lief.cpp — ELF (Linux) compression via LIEF (cross-platform)
// ============================================================================
//
// WHAT THIS FILE DOES
// Compresses a binary and embeds it as a SMOL section inside a Linux ELF
// stub executable using the LIEF C++ library. This enables building Linux
// self-extracting binaries from macOS or Windows build machines.
//
// WHY IT EXISTS
// You cannot manipulate ELF executables on non-Linux systems with native
// APIs. LIEF provides cross-platform ELF read/write, so this C++ file
// uses LIEF to parse an ELF stub, add the compressed data section, and
// write the final binary — all without needing Linux.
// ============================================================================
