...
const BufferProto = BufferCtor.prototype
...
const BufferPrototypeSlice = uncurryThis(BufferProto.slice)
const BufferPrototypeToString = uncurryThis(BufferProto.toString)
...
const FsRenameSync = fsModule.renameSync
...
const FsUnlinkSync = fsModule.unlinkSync
