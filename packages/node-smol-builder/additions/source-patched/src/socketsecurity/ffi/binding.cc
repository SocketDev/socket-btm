    ...
    switch (sig.return_type) {
      ...
      case FFIType::kString: {
        ...
        if (ret == nullptr) {
          ...
          result = String::NewFromUtf8(isolate, ret).ToLocalChecked();
        }
        break;
      }
      default:
