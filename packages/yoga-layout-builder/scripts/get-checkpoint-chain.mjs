 ...
 *
 * Example output (prod):
 *   finalized,wasm-synced,wasm-optimized,wasm-released,wasm-compiled,source-configured,source-cloned
 *
 * Example output (dev):
 *   finalized,wasm-synced,wasm-released,wasm-compiled,source-configured,source-cloned
 *
