 ...
 * 2. Preserves NODE_SEA sections from extracted source if present
 * 3. Removes the existing SMOL segment
 * 4. Creates a new SMOL segment with updated __PRESSED_DATA section
 * 5. Restores NODE_SEA sections if they were preserved
 * 6. Removes the code signature (will be invalid after changes)
 * 7. Writes the modified binary
 * 8. Signs with ad-hoc signature
 *
