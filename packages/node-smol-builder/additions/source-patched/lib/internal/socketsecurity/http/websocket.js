...
function nativeEncodeFrame(...args) { return smolHttp().encodeWebSocketFrame(...args); }
function nativeDecodeFrame(...args) { return smolHttp().decodeWebSocketFrame(...args); }
...
function decodeWebSocketFrame(buffer) {
  ...
  return {
    ...
    fin: frame.fin,
    opcode: frame.opcode,
    payload: BufferFrom(frame.payload.buffer, frame.payload.byteOffset, frame.payload.byteLength),
