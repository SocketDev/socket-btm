...
- Sync script: `packages/build-infra/scripts/sync-checksums.mjs`

Lookup priority: in-memory cache -> embedded checksums (offline) -> network fetch from GitHub (fallback).
