// ============================================================================
// compress_lief_common.hpp — Shared types and API for LIEF compression
// ============================================================================
//
// WHAT THIS FILE DOES
// Declares the compress_context_t struct (holds stub info and section data)
// and shared functions used by all three platform-specific compressors:
// compress_lief_common() (steps 1-3 of compression), helper print
// functions, output directory creation, and file verification.
//
// WHY IT EXISTS
// ELF, PE, and Mach-O compression all share the same first three steps:
// select a stub, compress the input, build the SMOL section. Only the
// final step (inserting the section into the binary) is format-specific.
// This header captures the shared contract.
// ============================================================================
