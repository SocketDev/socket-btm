...
static void update_config_init(update_config_t *config) {
    ...
    strncpy(config->binname, UPDATE_CONFIG_DEFAULT_BINNAME, UPDATE_CONFIG_MAX_BINNAME_LEN - 1);
    config->binname[UPDATE_CONFIG_MAX_BINNAME_LEN - 1] = '\0';
    strncpy(config->command, UPDATE_CONFIG_DEFAULT_COMMAND, UPDATE_CONFIG_MAX_COMMAND_LEN - 1);
    config->command[UPDATE_CONFIG_MAX_COMMAND_LEN - 1] = '\0';
    strncpy(config->url, UPDATE_CONFIG_DEFAULT_URL, UPDATE_CONFIG_MAX_URL_LEN - 1);
    config->url[UPDATE_CONFIG_MAX_URL_LEN - 1] = '\0';
    strncpy(config->tag, UPDATE_CONFIG_DEFAULT_TAG, UPDATE_CONFIG_MAX_TAG_LEN - 1);
    config->tag[UPDATE_CONFIG_MAX_TAG_LEN - 1] = '\0';
    strncpy(config->skip_env, UPDATE_CONFIG_DEFAULT_SKIP_ENV, UPDATE_CONFIG_MAX_SKIP_ENV_LEN - 1);
    config->skip_env[UPDATE_CONFIG_MAX_SKIP_ENV_LEN - 1] = '\0';
}
