...
// Generic resource names (cross-platform, used by binject)
export const RESOURCE_SMOL_VFS_BLOB = 'SMOL_VFS_BLOB'
export const RESOURCE_SMOL_VFS_CONFIG = 'SMOL_VFS_CONFIG'
