...
| `lib/download-with-progress` | 0 | Download with progress bar | ✅ REMOVED |
...
- ❌ `lib/cache-key`
- ❌ `lib/cmake-builder`
- ✅ `lib/download-with-progress` (REMOVED)
- ❌ `lib/rust-builder`
- ❌ `lib/wasm-pipeline`
- ❌ `lib/onnx-helpers`
...
1. Remove 6 completely unused modules:
   ...
   # ✅ COMPLETED: rm packages/build-infra/lib/download-with-progress.mjs
...
- cache-key, cmake-builder, ✅ download-with-progress (REMOVED)
