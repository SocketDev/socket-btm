...
import { getBuildMode } from '../../build-infra/lib/constants.mts'
import { logTransientErrorHelp } from '../../build-infra/lib/github-error-utils.mts'
import {
  getCurrentPlatformArch,
  isMusl,
} from '../../build-infra/lib/platform-mappings.mts'
...
const stubFiles = stubResults.map(r => r.value)
const [
  stubDarwinArm64,
  stubDarwinX64,
  stubLinuxArm64,
...
const cArrays = cArrayResults.map(r => r.value)
output += cArrays.join('')
