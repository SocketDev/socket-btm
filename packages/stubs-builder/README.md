...
3. Prepend platform-specific stub (from stubs-builder)
...
```
src/socketsecurity/stubs-builder/
...
- `CURL_CACHE_VERSION` - Dependency cache version for curl

**Workflow:** `.github/workflows/stubs.yml`
