 ...
 * Uses the directory containing the extracted binary (always writable).
 */
function getCacheDir() {
  ...
  // Extract to node_modules/ next to the extracted binary.
  // process.execPath points to ~/.socket/_dlx/<cache_key>/node
  // So dirname gives us ~/.socket/_dlx/<cache_key>/ which is always writable.
...
function mount(vfsPath, options = {}) {
  ...
  // Check if already extracted. Assumes extracted file is valid.
  // For stricter validation, could check file hash/mtime in future.
