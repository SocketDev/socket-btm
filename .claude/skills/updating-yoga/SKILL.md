...
- Find `export default yogaModule;` (ESM)
- Find `module.exports = yogaModule;` (CJS)
- Replace with wrapped version

**Note:** The variable is named `yogaModule` (not `yogaPromise`) because the sync wrapper
is truly synchronous (`-sWASM_ASYNC_COMPILATION=0`), not a promise.
