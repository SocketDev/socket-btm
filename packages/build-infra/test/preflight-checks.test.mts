...
vi.mock<typeof import('../lib/build-helpers.mjs')>(
  import('../lib/build-helpers.mjs'),
  () => ({
    checkCompiler: vi.fn(),
...
vi.mock<typeof import('../lib/build-output.mjs')>(
  import('../lib/build-output.mjs'),
  () => ({
    printError: vi.fn(),
  }),
)

vi.mock<typeof import('../lib/version-helpers.mjs')>(
  import('../lib/version-helpers.mjs'),
  () => ({
...
describe('preflight-checks', () => {
  let mockCheckDiskSpace: any
  let mockCheckCompiler: any
  let mockCheckPythonVersion: any
