 ...
 * - platform_metadata (5 bytes): platform, arch, libc, compression_algorithm, reserved
 ...
 * @param compression_algorithm Compression algorithm (0=LZFSE, 1=LZMA, 2=LZMS).
 ...
 *
 * Detects platform, architecture, libc, and compression algorithm based on
 * compiler macros (__APPLE__, __linux__, _WIN32, __arm64__, __aarch64__, etc.).
 *
 ...
 * @param compression_algorithm Output: Compression algorithm (0=LZFSE, 1=LZMA, 2=LZMS).
 */
